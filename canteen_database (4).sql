...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 05, 2025 at 04:38 PM
...
INSERT INTO `items` (`item_id`, `name`, `price`, `category`, `availability`, `image_path`, `stall_id`) VALUES
...
('ORDER_67c6639c35d930.43338784', 6, 2.99, '2025-03-04 02:21:16', 'Pending'),
('ORDER_67c663c7433022.37286136', 6, 22.41, '2025-03-04 02:21:59', 'Pending');
...
(16, 'ORDER_67c6639c35d930.43338784', 6, 2.99, 'balance', 'completed', '2025-03-04 02:21:16'),
(17, 'ORDER_67c663c7433022.37286136', 6, 22.41, 'paymaya', 'completed', '2025-03-04 02:21:59');
...
INSERT INTO `users` (`user_id`, `name`, `email`, `password`, `role`, `balance`, `phone`, `address`, `image_path`, `failed_attempts`, `locked_until`) VALUES
(1, 'Allan Monforte', 'allanmonforte@gmail.com', '$2y$10$j2Xm9vb2YSUD310EVE.ghuUyudfpgNF8E6QrNTamqhHvv/OBlVFdm', 'Student', 847.65, '09686827403', '285 PNR Site, Western Bicutan Taguig City, Western Bicutan', 'images/profiles/67b71f8628b2f_RobloxScreenShot20250219_220845337.png', 0, NULL),
(2, 'EGAY', 'ego123123@gmail.net', '$2y$10$jTeazZ6pzHdI2d5dSxkIdu65pLFLM7xpyR6mmExVIcrb1vSdoxgVq', 'Student', 99999999.99, '6969', 'gayland', 'images/default-profile.jpg', 0, NULL),
(3, 'Melvin', 'melvin1234@gmail.com', '$2y$10$3sdO.wGghgce/3n6jipIh.syBETL7VagujIPjIKXiUFh7inGO6DpK', 'Student', 0.00, NULL, NULL, 'images/default-profile.jpg', 0, NULL),
(4, 'zcdasad@gasfsas.coaj', '123123@gmail.com', '$2y$10$.7F2Ud.lXqib.uNErYlc1uVy162S.7KKxeB64PyORXj8sHhBx5aTq', 'Student', 0.00, NULL, NULL, 'images/default-profile.jpg', 0, NULL),
(5, 'allan monforte porto', 'allan123@gmail.com', '$2y$10$CUxcH8PsjnM8YZ.CL7.0E.r7MJQn7IdTM.H86G5/B./jGrv5X4/g.', 'Student', 999993.01, NULL, NULL, 'images/default-profile.jpg', 0, NULL),
(6, 'egoian', 'ego123@gmail.com', '$2y$10$v7CN02fZjTAVgoheVDzBWOiHtbnsTRbxZGJHyp/v7mf4seTHKKWSy', 'Student', 99996.01, NULL, NULL, 'images/default-profile.jpg', 0, NULL),
(7, 'Levi', 'l@gmail.com', '$2y$10$VC3Mx/ZgeOxoqDSftbOFveIxSZbksGeYSCKb.HN1xVMF7gVcbESJS', 'Retailer', 0.00, NULL, NULL, 'images/default-profile.jpg', 0, NULL),
(8, 'Melvin', 'ad123min@gmail.com', '$2y$10$mQ2loMJIzrdzO/J.xz/gpeFJzl6KU2SuQ8ALa5fGon/IrzCqI.2CO', 'Admin', 0.00, NULL, NULL, 'images/default-profile.jpg', 0, '2025-03-05 15:49:41'),
(11, 'Egoadmin', 'ad123min@gmail.com', '$2y$10$wL3WQWAYLYQXnUHzwJyS3eEtKwrAI7WDb0h3gObDsY.Kr7vN2n.kq', 'Admin', 0.00, NULL, NULL, 'images/default-profile.jpg', 0, NULL),
(12, 'Super', 'ad123min@gmail.com', '$2y$10$/OIQYb2G54/WGM6KbrWoJuB7iMoUabgPaaL3LipTucPpti4w/DZ8C', 'Admin', 0.00, NULL, NULL, 'images/default-profile.jpg', 0, NULL),
(13, 'hello', 'ad123min@gmail.com', '$2y$10$MqKgDbyWizHq.2JN0JSS/uyNGkDVk.mClRBWXxFhsv9GToC.q2r3u', 'Admin', 0.00, NULL, NULL, 'images/default-profile.jpg', 0, NULL),
(14, 'you', 'ad123min@gmail.com', '$2y$10$iBg5OM6q0yHZFDZKpzOgDepyQb4psQwPneMSlw6mShMRZmwIPabBG', 'Admin', 0.00, NULL, NULL, 'images/default-profile.jpg', 0, NULL);
...
--
ALTER TABLE `inventory`
  ADD CONSTRAINT `inventory_ibfk_1` FOREIGN KEY (`item_id`) REFERENCES `items` (`item_id`) ON DELETE CASCADE;
...
ALTER TABLE `order_details`
  ...
  ADD CONSTRAINT `order_details_ibfk_2` FOREIGN KEY (`item_id`) REFERENCES `items` (`item_id`) ON DELETE CASCADE;
